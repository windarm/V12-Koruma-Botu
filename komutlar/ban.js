...
let kanal = ''//Log Kanal İD Yazın

if(!member) return message.channel.send("<:red_square:1046431320991076352> **Bir Üye Belirtiniz**")



if(!sebep) return message.channel.send("<:red_square:1046431320991076352>  **Bir Sebep Giriniz**")
